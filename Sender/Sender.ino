...
void loop() {
    ...
    x = abs(x) < MOTOR_MIN_SPEED ? 0 : (x > MOTOR_MAX_SPEED ? MOTOR_MAX_SPEED : (x < -MOTOR_MAX_SPEED ? -MOTOR_MAX_SPEED : x));
    y = abs(y) < MOTOR_MIN_SPEED ? 0 : (y > MOTOR_MAX_SPEED ? MOTOR_MAX_SPEED : (y < -MOTOR_MAX_SPEED ? -MOTOR_MAX_SPEED : y));
